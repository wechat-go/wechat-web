  ...
  <div class="login-container">
    ...
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <el-row style="margin-bottom:10px;" type="flex" justify="space-between">
        ...
        <el-col :span="12" style="text-align:right;color:#fff">
      ...
      <el-row type="flex" justify="space-between">
        <el-button type="primary" style="width:48%;" :loading="loading" @click.native.prevent="handleLogin">{{$t('login.logIn')}}</el-button>
        <router-link to="/register" style="width:48%;">
